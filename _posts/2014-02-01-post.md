...
description: "MikuMikuMoving在很多方面都要比MMD好用一些，但是目前最大的问题就是有些很重要的MME在MMM里面没法使用，比如HalfLambertShader Ver0.301，以下略称HLShader。但是根据官方给出的文档和范例，可以对其进行改造。"
...
**PS1：发布完整修改的代码是不可能的，第一我不太清楚改造或者二配之类的问题，第二因为我完全不懂HLSL编程，所以里面还存留着很多无意义的代码和小BUG，虽然好像不影响使用，但是我实在拿不出手……我只是分享一下方法给有需要的人，网上哪里都找不到这方面的教程……**  
...
###1. 在地面阴影模式下HLShader不起作用，而在本影模式下虽然起作用，但是动作却不起作用了 
...
![](http://i87.photobucket.com/albums/k126/SoraNoIseki/blog/2014/20140130-01_zps5302fd22.jpg)
...
![](http://i87.photobucket.com/albums/k126/SoraNoIseki/blog/2014/20140130-02_zpse0f62dc2.jpg)